...
function ReviewStep({ formData }) {
  ...
  return (
    <div className="block">
      ...
      <div className="bg-white p-0">
        ...
        <div className="flex items-center gap-8 ">
          ...
          {(formData.address || formData.city || formData.postcode) && (
            <div className="flex items-start gap-2 text-darkGray mb-3 relative after:content-[''] after:absolute after:bottom-[5px] after:right-[-17px] after:w-[2px] after:h-[18px] after:bg-midGray">
              <BlueLocationIcon />
        ...
        <div className="border border-lightGray rounded-xl p-6 mb-4">
          {/* Amenities */}
          {formData.amenities.length > 0 && (
            <div className="mb-4">
              <h4 className="text-xl font-bold font-nunito text-secondary mb-3">
                Amenities
              </h4>
      ...
      <div className="border border-lightGray rounded-xl p-6 mb-4 space-y-4">
        {/* Renter Profile Description */}
        {formData.renterProfileDescription && (
          <div className="block">
            <h4 className="text-xl font-bold font-nunito text-secondary mb-2">
              Renter Profile Description
            </h4>
            <p className="text-base font-normal font-nunito text-darkGray">
              {readMoreDescription
