                ...
                >
                  ...
                  {!image.uploading && (
                    <button
                      ...
                      className="absolute top-1 right-1 bg-white text-red-600 rounded-full p-1.5 hover:bg-red-50 z-10 shadow-sm"
                    >
                  ...
                  {index !== 0 && !image.uploading && (
                    <button
                      ...
                      className="absolute bottom-2 left-2 right-2 bg-[#6B4EFF] text-white text-xs px-2 py-1 rounded-lg z-10 font-medium hover:bg-opacity-90"
                    >
                      Set as Main
                    </button>
                  )}
