                    ...
                    >
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-bold font-nunito text-secondary text-base truncate lg:w-[200px]">
                              {property.description}
                            </p>
                            <p className="text-darkGray text-base font-nunito font-normal truncate lg:w-[200px]">
                              ID: {property.id}
                            </p>
                          </div>
                        </div>
                          ...
                          {openDropdownId === property.id && (
                            <div className="absolute right-0 mt-2 w-32 bg-white border border-lightGray rounded-lg shadow-lg z-10">
                              ...
                              <button
                                ...
                                className="flex items-center gap-2 w-full text-left px-3 py-1 text-base text-darkGray font-nunito font-medium hover:bg-gray-50"
                              >
