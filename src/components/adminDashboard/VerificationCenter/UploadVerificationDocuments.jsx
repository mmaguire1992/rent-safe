    ...
    <div className="bg-white rounded-[14px] border border-lightGray md:p-4 p-3">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-6 py-2 bg-blueGradient text-white rounded-[10px] hover:bg-opacity-90 transition-colors font-bold font-nunito shadow-[0px_2px_10px_0px_#00000033]"
          >
            Submit for Review
          </button>
        </div>
