  ...
  if (pathSegments[0] === "dashboard") {
    ...
    if (pathSegments[1] === "properties") {
      ...
      // Handle property detail
        ...
        try {
          ...
          breadcrumbs.push({
            label: customLabels.propertyTitle || propertyData?.title || `Property ${params.id}`,
    ...
    // Handle tenant routes - Include Dashboard
      ...
      try {
        ...
        breadcrumbs.push({
          label: customLabels.tenantName || `${tenantData?.name}'s Profile` || `Tenant ${params.id}`,
        ...
        if (pathSegments[3] === "rental-history") {
          breadcrumbs.push({
            label: customLabels.rentalHistory || routeLabels["rental-history"] || "Reviews",
