function SharersIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M13.333 2.60645C14.0478 2.79175 14.6808 3.20917 15.1327 3.79316C15.5846 4.37716 15.8298 5.09469 15.8298 5.83311C15.8298 6.57154 15.5846 7.28906 15.1327 7.87306C14.6808 8.45706 14.0478 8.87447 13.333 9.05978"
        stroke="#FF1E8E"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
