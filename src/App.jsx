...
import PlansBilling from "@/pages/PlansBilling/PlansBilling";
...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/signup/owner/verify-account"
        element={<OwnerVerifyAccount />}
      />
      ...
      <Route
        path="/signup/renter/share-thoughts"
        element={<RenterShareThoughts />}
      />
      ...
      <Route path="/dashboard/payments" element={<PlansBilling />} />
      <Route path="/dashboard/verification" element={<VerificationCenter />} />
      <Route path="/dashboard/profile" element={<ProfileSettings />} />
      <Route path="/dashboard/support" element={<Support />} />
      <Route path="/dashboard/tenant/:id" element={<TenantProfile />} />
      <Route
        path="/dashboard/tenant/:id/rental-history"
